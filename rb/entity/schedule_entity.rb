...
class ScheduleEntity
  ...
  def data_set(args)
    if args
      @_data = LmSmsHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  def match_set(args)
    if args
      @_match = LmSmsHelpers.to_map(VoxgigStruct.clone(args)) || {}
  ...
  # @return [Schedule, Hash] the loaded Schedule; raises LmSmsError on failure
    ...
    _run_op(ctx) do
      if ctx.result
        ...
        if ctx.result.resdata
          @_data = LmSmsHelpers.to_map(VoxgigStruct.clone(ctx.result.resdata)) || {}
        end
      end
    end
  end
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Array<Schedule>, Array] the matching Schedule items; raises LmSmsError on failure
  ...
  #
  # @param reqdata [ScheduleUpdateData, Hash, nil] body data
  # @param ctrl [Object, nil] optional per-call control
  # @return [Schedule, Hash] the updated Schedule; raises LmSmsError on failure
  ...
  # @param ctrl [Object, nil] optional per-call control
  # @return [Schedule, Hash] the removed Schedule; raises LmSmsError on failure
