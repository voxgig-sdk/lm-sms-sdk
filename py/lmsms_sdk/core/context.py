...
from lmsms_sdk.core.helpers import get_ctx_prop, to_map
...
class LmSmsContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        if isinstance(rp, LmSmsResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def make_error(self, code, msg):
        return LmSmsError(code, msg, self)
