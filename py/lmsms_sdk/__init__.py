...
from lmsms_sdk.utility import register

# Load features
from lmsms_sdk.feature.base_feature import LmSmsBaseFeature
from lmsms_sdk.features import _has_feature, _make_feature
...
class LmSmsSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = LmSmsUtility()
        self._utility = utility

        from lmsms_sdk.config import shared_config
    ...
    def get_utility(self):
        return LmSmsUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("LmSmsSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Schedule(self, data=None) -> "ScheduleEntity":
        ...
        from lmsms_sdk.entity.schedule_entity import ScheduleEntity
    ...
    def SendMessage(self, data=None) -> "SendMessageEntity":
        ...
        from lmsms_sdk.entity.send_message_entity import SendMessageEntity
        return SendMessageEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "LmSmsSDK":
        if sdkopts is None:
            sdkopts = {}
