...
from lmsms_sdk.core.response import LmSmsResponse
from lmsms_sdk.core.operation import LmSmsOperation
...
class TestPrimaryUtility:
    ...
    def test_exists(self):
        client = LmSmsSDK.test(None, None)
    ...
    def test_feature_init_basic(self):
        init_client = LmSmsSDK.test(None, None)
        ...
        class TestInitFeature(LmSmsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "initfeat"
                self.active = True
    ...
    def test_feature_init_inactive(self):
        ...
        class TestInitFeatureInactive(LmSmsBaseFeature):
            def __init__(self):
                super().__init__()
                self.name = "nofeat"
                self.active = False
    ...
    def test_make_spec_basic(self):
        ...
        spec_client = LmSmsSDK.test(None, setup_opts)
    ...
    def test_prepare_auth_basic(self):
        ...
        auth_client = LmSmsSDK.test(None, setup_opts)
