# LmSms SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions LmSmsSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both LmSmsSDK(...) and LmSmsSDK.test(...) become
#      LmSmsSDK.test({"entity": {...}}) seeding one mock record (id "test01")
