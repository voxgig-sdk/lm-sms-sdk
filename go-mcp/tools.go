...
type Args struct {
	Entity string         `json:"entity" jsonschema:"schedule | send_message"`
	Query  map[string]any `json:"query,omitempty" jsonschema:"optional match map e.g. {\"id\":1} for load, omit for list"`
}

func registerTools(server *mcp.Server, client *sdk.LmSmsSDK) {
	mcp.AddTool(server, &mcp.Tool{
		Name: "lm-sms_list",
		Description: "List records from LmSms. " +
	...
	mcp.AddTool(server, &mcp.Tool{
		Name: "lm-sms_load",
		Description: "Load a single record from LmSms. " +
...
func runOp(client *sdk.LmSmsSDK, op string, args Args) (*mcp.CallToolResult, any, error) {
...
func entityFor(client *sdk.LmSmsSDK, name string) (sdk.LmSmsEntity, error) {
