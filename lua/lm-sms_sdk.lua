...
LmSmsSDK._make_feature = _make_feature


function LmSmsSDK.new(options)
  local self = setmetatable({}, LmSmsSDK)
  self.mode = "live"
  self.features = {}
  self.options = nil
...
function LmSmsSDK:get_utility()
  return Utility.copy(self._utility)
end


function LmSmsSDK:get_root_ctx()
  return self._rootctx
end


function LmSmsSDK:prepare(fetchargs)
...
function LmSmsSDK:direct(fetchargs)
...
-- by passing it.
function LmSmsSDK:_raw_request(fetchargs)
  local utility = self._utility
...
function LmSmsSDK:graphql(query, variables, ctrl)
...
function LmSmsSDK:Schedule(data)
...
-- Entity access is capitalised (PascalCase) for parity with the other SDKs.
function LmSmsSDK:SendMessage(data)
...
function LmSmsSDK.test(testopts, sdkopts)
  sdkopts = sdkopts or {}
  ...
  local sdk = LmSmsSDK.new(sdkopts)
  sdk.mode = "test"
