...
func NewScheduleEntity(client *core.LmSmsSDK, entopts map[string]any) *ScheduleEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *ScheduleEntity) Update(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
	ctx := utility.MakeContext(map[string]any{
		"opname":  "update",
		"ctrl":    ctrl,
...
// ScheduleUpdateData and returns an Schedule. It delegates to the untyped
// Update (identical runtime) and converts at the typed boundary.
func (e *ScheduleEntity) UpdateTyped(reqdata ScheduleUpdateData, ctrl map[string]any) (Schedule, error) {
