...
func (sdk *LmSmsSDK) GetUtility() *Utility {
	return CopyUtility(sdk.utility)
}

func (sdk *LmSmsSDK) GetRootCtx() *Context {
	return sdk.rootctx
}

func (sdk *LmSmsSDK) Prepare(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *LmSmsSDK) Direct(fetchargs map[string]any) (map[string]any, error) {
...
func (sdk *LmSmsSDK) opAllowed(op string) bool {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return strings.Contains(allowOp, op)
}

func (sdk *LmSmsSDK) opDenied(op string) map[string]any {
	allowOp, _ := vs.GetPath([]any{"allow", "op"}, sdk.options).(string)
	return map[string]any{
		"ok": false,
		"err": fmt.Errorf("LmSmsSDK: %s: operation not allowed by"+
...
// gate by passing it.
func (sdk *LmSmsSDK) rawRequest(fetchargs map[string]any) (map[string]any, error) {
	utility := sdk.utility
...
func (sdk *LmSmsSDK) Graphql(
	...
	if 0 < len(errors) {
		...
		res["ok"] = false
		res["err"] = fmt.Errorf("LmSmsSDK: graphql: %s", msg)
		res["graphql"] = errors
	}
...
func (sdk *LmSmsSDK) Schedule(data map[string]any) LmSmsEntity {
...
func (sdk *LmSmsSDK) SendMessage(data map[string]any) LmSmsEntity {
