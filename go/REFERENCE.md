# LmSms Golang SDK Reference

Complete API reference for the LmSms Golang SDK.
...
#### `TestSDK(testopts, sdkopts map[string]any) *LmSmsSDK`
...
#### `Schedule(data map[string]any) LmSmsEntity`

Create a new `Schedule` entity instance. Pass `nil` for no initial data.

#### `SendMessage(data map[string]any) LmSmsEntity`
