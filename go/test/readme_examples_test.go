...
const testSeed = `map[string]any{"entity": map[string]any{"schedule": map[string]any{"example_id": map[string]any{"id": "example_id"}}, "send_message": map[string]any{"example_id": map[string]any{"id": "example_id"}}}}`
