...
class StructUtilityTest extends TestCase
{
    ...
    {
        if (self::$run === null) {
            $runner = LmSmsOmni::makeStructRunner(
        ...
        $this->runsection(
            ...
            function ($input) {
                ...
                if (is_object($store) && $haspath && Struct::undef() !== $val) {
                    ...
                    if (json_encode(LmSmsOmni::structfix($now, Struct::undef()))
                        !== json_encode(LmSmsOmni::structfix($val, Struct::undef()))) {
