...
class LmSmsProxyFeature extends LmSmsBaseFeature
{
    ...
    public function init(LmSmsContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (LmSmsContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
