...
class LmSmsPagingFeature extends LmSmsBaseFeature
{
    ...
    private function _graphql_pre_request(LmSmsContext $ctx, array $paging): void
    {
        $body = $ctx->spec->body;
        if (!is_array($body)) {
            return;
    ...
    private function _is_list(LmSmsContext $ctx): bool
    {
