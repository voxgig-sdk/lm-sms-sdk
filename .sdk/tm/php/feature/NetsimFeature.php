...
class LmSmsNetsimFeature extends LmSmsBaseFeature
{
    ...
    private function _simulate(LmSmsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(LmSmsContext $ctx, array $applied): void
    {
        $client = $this->client;
