...
class LmSmsCacheFeature extends LmSmsBaseFeature
{
    ...
    private function _through(LmSmsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
