...
// LmSms SDK test feature

require_once __DIR__ . '/BaseFeature.php';
require_once __DIR__ . '/../utility/Param.php';

class LmSmsTestFeature extends LmSmsBaseFeature
{
    ...
    public function init(LmSmsContext $ctx, array $options): void
    {
        ...
        $test_fetcher = function (LmSmsContext $fctx, string $_fullurl, array $_fetchdef) use ($entity): array {
    ...
    public function makeNetsim(array $net, callable $inner): callable
    {
        ...
        return function (LmSmsContext $fctx, string $url, array $fetchdef) use ($net, $inner, $pick_latency, $sleep): array {
            $this->_netcalls++;
            $call = $this->_netcalls;
     ...
     */
    public function buildArgs(LmSmsContext $ctx, $op, $args): array
    {
