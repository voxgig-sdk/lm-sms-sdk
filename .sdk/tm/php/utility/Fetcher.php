...
class LmSmsFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; LmSmsSDK/1.0)';
    ...
    public static function call(LmSmsContext $ctx, string $fullurl, array $fetchdef): array
    {
