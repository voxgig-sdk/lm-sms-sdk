...
|---|---|---|
| `ts/` | @voxgig-sdk/lm-sms | `.github/workflows/publish-ts.yml` |
...
required):
    ...
    npm trust github @voxgig-sdk/lm-sms \
      --repository voxgig-sdk/lm-sms-sdk \
      --file publish-ts.yml \
      --allow-publish

Then `npm trust list @voxgig-sdk/lm-sms` shows it, and
`npm trust revoke @voxgig-sdk/lm-sms --id=<id>` removes it.
