...
function liveScenariosActive() { return false && process.env.LM_SMS_TEST_LIVE === 'TRUE'; }
function directSetup(mockres) {
    ...
    if (live) {
        ...
        const client = new __1.LmSmsSDK(Object.assign({}, (0, utility_1.liveClientOptions)(), { system: { fetch: transport.fetch },
            apikey: env.LM_SMS_APIKEY,
        }));
        let idmap = env['LM_SMS_TEST_SCHEDULE_ENTID'];
