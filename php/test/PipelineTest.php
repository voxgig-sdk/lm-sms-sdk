...
{
    private static function utility(): LmSmsUtility
    {
        return new LmSmsUtility();
    }
    ...
    private static function ctx(array $over = []): LmSmsContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new LmSmsContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new LmSmsOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof LmSmsError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new LmSmsOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = LmSmsMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new LmSmsOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = LmSmsMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new LmSmsOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = LmSmsMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LmSmsSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = LmSmsMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new LmSmsResponse([]),
            'result' => new LmSmsResult([]),
        ]);
        [, $err] = LmSmsMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new LmSmsSpec(['step' => 's']),
            'response' => new LmSmsResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new LmSmsResult([]),
        ]);
        [, $err] = LmSmsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new LmSmsSpec(['step' => 's']),
            'response' => new LmSmsResponse(self::resp(200, ['v' => 1])),
            'result' => new LmSmsResult([]),
        ]);
        [, $err] = LmSmsMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new LmSmsSpec(['step' => 's']),
            'response' => new LmSmsResponse(self::resp(200, ['v' => 2])),
            'result' => new LmSmsResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        LmSmsMakeResponse::call($ctx);
    ...
    {
        $preset = new LmSmsResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new LmSmsSpec([]),
            'response' => new LmSmsResponse([]),
            'result' => new LmSmsResult([]),
        ...
        [$got, $err] = LmSmsMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new LmSmsResult([])]);
        [, $err] = LmSmsMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new LmSmsSpec([]), 'result' => null]);
        [, $err] = LmSmsMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LmSmsSpec(['step' => 's']),
            'result' => new LmSmsResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new LmSmsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LmSmsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new LmSmsSpec(['step' => 's']),
            'result' => new LmSmsResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new LmSmsOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = LmSmsMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new LmSmsResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new LmSmsSpec([]),
            'result' => new LmSmsResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = LmSmsMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $utility = self::utility();
        $boom = new LmSmsError('boom', 'boom');
        $utility->fetcher = function (LmSmsContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LmSmsSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = LmSmsMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (LmSmsContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = LmSmsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(LmSmsResponse::class, $response);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (LmSmsContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new LmSmsSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = LmSmsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new LmSmsResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new LmSmsSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = LmSmsMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = LmSmsMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = LmSmsMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new LmSmsResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, LmSmsDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new LmSmsResult(['ok' => false])]);
        $this->expectException(LmSmsError::class);
        LmSmsDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new LmSmsResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', LmSmsMakeError::call($ctx, null));
    }
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new LmSmsBaseFeature();
        $b = new LmSmsBaseFeature();
        LmSmsFeatureAdd::call($ctx, $a);
        LmSmsFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): LmSmsBaseFeature
    {
        $f = new LmSmsBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    private static function auth_ctx(array $options, ?array $headers): LmSmsContext
    {
        $client = new PlClient($options);
        return self::ctx([
            'client' => $client,
            'spec' => $headers === null ? null : new LmSmsSpec(['headers' => $headers]),
        ]);
    }
    ...
    {
        $ctx = self::ctx([
            'response' => new LmSmsResponse(['headers' => null]),
            'result' => new LmSmsResult([]),
        ]);
        LmSmsResultHeaders::call($ctx);
