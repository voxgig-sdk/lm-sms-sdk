...
// LmSms SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (LmSmsSDK::test)
...
{
    private const SDK_CLASS = 'LmSmsSDK';
    ...
    private const SDK_BASE = 'lmsms_sdk';
