...
// LmSms SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class LmSmsMakeRequest
{
    public static function call(LmSmsContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new LmSmsResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new LmSmsResponse($fetched);
        } else {
