...
class LmSmsStreamingFeature extends LmSmsBaseFeature
{
    ...
    private function _iterate(LmSmsResult $result): \Generator
    {
    ...
    private function _streamable(LmSmsContext $ctx): bool
    {
