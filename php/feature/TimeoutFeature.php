...
class LmSmsTimeoutFeature extends LmSmsBaseFeature
{
    ...
    private function _with_timeout(LmSmsContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(LmSmsContext $_ctx, float $ms): void
    {
        $client = $this->client;
