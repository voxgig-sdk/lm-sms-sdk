...
class LmSmsRatelimitFeature extends LmSmsBaseFeature
{
    ...
    private function _acquire(LmSmsContext $ctx): void
    {
    ...
    private function _track(LmSmsContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
