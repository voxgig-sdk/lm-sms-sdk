...
class LmSmsRbacFeature extends LmSmsBaseFeature
{
    ...
    private function _required(LmSmsContext $ctx): ?string
    {
    ...
    private function _reject(LmSmsContext $ctx, string $required): void
    {
    ...
    private function _track(LmSmsContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
